...
if(isset($_POST['connexion'])) {
   ...
   if(!empty($nomco) AND !empty($mdpco)) {
      $req = $bdd->prepare("SELECT * FROM admins WHERE nom= ? AND mdpass = ?");
      $req->execute(array($nomco, $mdpco));
    

        header("Location: admin2.php?nom=".$_SESSION['nom']);
     } else {
...
<article class="card-body mx-auto" style="max-width: 300px;">
	...
	<div class="form-group input-group">
        ...
        <input name="nomco" class="form-control" placeholder="Nom" type="text">
    ...
    <div class="form-group input-group">
        ...
        <input name="mdpco" class="form-control" placeholder="Mot de passe" type="password">
    </div> <!-- form-group// -->
